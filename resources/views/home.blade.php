        ...
        <main class="w-100" style="margin-top:68px ;">
            <section class="w-100" id="introduction" style="height: 580px;">
                <div class="container text-white d-flex py-5 flex-lg-row  h-100" style="z-index:1027">
                    <div class="information_user d-flex justify-content-center justify-content-lg-start"
                        style="width:350px ;">
                        <div class="content h-100 row row-cols-1 mx-0 d-flex justify-content-center py-4"
                            style="width: 350px;border-radius:0.7rem !important;overflow:hidden;">
                            <img src="Images/users/{{ Auth::user()->image }}" class="img-user p-0"
                                id="active-image"></img>
                            <div class="information pt-4">
                                ...
                                <div class="xp">
                                    <p><i class="fa-solid fa-star pe-2"></i><span
                                            class='xp-value'>{{ Auth::user()->xp }}</span>XP</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="definition w-100 mt-4 d-flex flex-column justify-content-center">
                <div class="container rounded-3">
                    <div class="debut content text-center fw-bold mb-4">
                        ...
                        <p class="difinition_text  fs-3">Our course covers basic concepts, variables, arrays,
                            conditional statements, loops, functions, strings, and much more.</p>
                    </div>
                    <div class="content row row-cols-1 mx-auto mx-lg-0 row-cols-lg-3 p-0 pb-5">
                        <div class='card-niveu d-flex justify-content-center justify-content-lg-start '>
                            <div class="card {{ $session_1['session_progress'] >= 7 ? 'valid' : 'active' }} py-3 h-100"
                                style="width: 360px;">
                                ...
                                <div class="progress-niveu progress-start px-4 my-2 w-100">
                                    <div class="progress-information ">
                                        <div class=" d-flex position-relative flex-row">
                                            ...
                                            <span class="progress-result position-absolute end-0 fs-3"><span
                                                    class="result-pro">{{ $session_1['session_progress'] }}</span>/10</span>
                                        </div>
                                        <div class="progress mt-2">
                                            <div class="progress-bar" role="progressbar"
                                                style="width: {{ $session_1['session_progress'] == 0 ? '' : $session_1['session_progress'] }}0%"
                                                aria-valuenow="{{ $session_1['session_progress'] }}" aria-valuemin="0"
                        ...
                        <div class='card-niveu d-flex justify-content-center'>
                            <div class="card @if (isset($session_2)) @if ($session_2['session_progress'] >= 7)
                                    {{ 'valid' }}
                                @else
                                    {{ 'active' }} @endif
@else
                            ...
                            @endif  py-3 h-100 "
                                ...
                                <div class="progress-niveu  px-4 my-2 w-100">
                                    <div class="progress-information">
                                        ...
                                        <div class="progress mt-2">
                                            <div class="progress-bar" role="progressbar"
                                                style="width:    @if (isset($session_2)) @if ($session_2['session_progress'] == 0)
                                                                    {{ '0%' }}
                                                                @else
                                                                    {{ $session_2['session_progress'] . '0%' }} @endif
@else
{{ '0%' }}
                                                            @endif "
                                                aria-valuenow="@if (isset($session_2)) {{ $session_2['session_progress'] }}
                                                @else
                                                    {{ 0 }} @endif"
                                ...
                                <div class="card-access h-100 w-100 d-flex justify-content-center align-items-center">
                                    <a href="@if (isset($session_2)) {{ '/test/' . $session_2['id'] }} @endif"
                                        class="fa-solid">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class='card-niveu d-flex justify-content-center justify-content-lg-end '>
                            <div class="card @if (isset($session_3)) @if ($session_3['session_progress'] >= 7)
                                {{ 'valid' }}
                            @else
                                {{ 'active' }} @endif
@else
                        ...
                        @endif py-3 h-100 "
                                ...
                                <div class="progress-niveu  px-4 my-2 w-100">
                                    <div class="progress-information">
                                        ...
                                        <div class="progress mt-2">
                                            <div class="progress-bar" role="progressbar"
                                                style="width: @if (isset($session_3)) @if ($session_3['session_progress'] == 0)
                                                {{ '0%' }}
                                            @else
                                                {{ $session_3['session_progress'] . '0%' }} @endif
@else
{{ '0%' }}
                                        @endif "
                                                aria-valuenow="@if (isset($session_3)) {{ $session_3['session_progress'] }}
                                                @else
                                                    {{ 0 }} @endif"
                                                aria-valuemin="0" aria-valuemax="10"></div>
                                        </div>
                                ...
                                <div class="card-access h-100 w-100  d-flex justify-content-center align-items-center">
                                    <a href="@if (isset($session_3)) {{ '/test/' . $session_3['id'] }} @endif"
                                        class="fa-solid">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="certificate w-100 mt-4">
                            <div class="content">
                                <div class="certificate_info">
                                    <div
                                        class="d-flex shadow-title certificate_title_desktop justify-content-center py-4 mb-2">
                                        <p class="difinition-title fs-1 ">Certification</p>
                                    </div>
                                    <p class="certificate_info-text text-center fs-3">In order to get you certificate
                                        you should first finish all the levels.
                                        <br>
                                ...
                                <div class="get-certificate h-100 pt-5 pe-5 me-lg-l5">
                                    <div>
                                        ...
                                        <p class="result-certificate">
                                            <span
                                                class="progress-result">{{ $certificate['language_progress'] }}</span>%
                                        </p>
                                        <div class=" progress progress-certificate w-75">
                                            <div class="progress-bar" role="progressbar"
                                                style="width: {{ $certificate['language_progress'] }}%"
                                                aria-valuenow="{{ $certificate['language_progress'] }}"
                                    ...
                                    <!--disabled-->
                                    <button
                                        class="btn btn-war border-0 {{ $certificate['language_progress'] == 100 ? '' : 'disabled' }} btn-primary shadow-primary btn-get-certificate"
                                        @if ($certificate['language_progress'] == 100) data-bs-toggle="modal" data-bs-target="#staticBackdrop" @endif
                                        style="font-weight: 600;">Acquire your certificate</button>
                                            ...
                                            <div class="modal-dialog  modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-body-certificate px-4">
                                                        <div
                                                            class="Modal certificate-footer d-flex justify-content-between my-3">
                                                            <h5 class="modal-title text-black fw-bold fs-4"
                                                                id="staticBackdropLabel">Certificate</h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="img">
                                                            <img src="/Images/certificate/{{ $certificate['certificate_id'] }}.jpg"
                                                                width="100%" alt="">
                                                        </div>
                                                        <div class="copy-link my-4 d-flex justify-content-between">
                                                            <div class="form-input position-relative"
                                                                style="width:80%;">
                                                                <input id="link-certificate" type="text"
                                                                    class="h-100 w-100 rounded-3  shadow-primary-input border-nor text-dark fs-6"
                                                                    readonly
                                                                    value="http://127.0.0.1:8000/Images/certificate/{{ $certificate['certificate_id'] }}.jpg" />
                                                                <i class="bi bi-link-45deg fs-5 position-absolute top-50 translate-middle fs-5 text-nor"
                                                                    style="left: 7%;"></i>
                                                            </div>
                                                            <div>
                                                                <button id="btn-copy"
                                                                    class="btn h-100 fw-bold text-nor  border-nor shadow-primary-input">
                                                                    Copy
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <div
                                                            class="download_certificate d-flex justify-content-between my-3">
                                                            <a href="/certificate/jpg/{{ $certificate['certificate_id'] }}"
                                                                class="btn btn-war border-0 shadow-primary btn-primary"
                                                                style="font-weight: 600;">Download JPG</a>
                                                            <a href="/certificate/pdf/{{ $certificate['certificate_id'] }}"
                                                                class="btn btn-war border-0 shadow-primary btn-primary"
                                                                style="font-weight: 600;">Download PDF</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
